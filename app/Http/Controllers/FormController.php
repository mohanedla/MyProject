...
class FormController extends Controller
{
    ...
    public function viewRecord()
    {
        ...
        return view('dashboard.view_record.viewrecord',compact('data'));
    }
    ...
    public function viewDetail($id)
    {
        ...
        return view('dashboard.view_record.viewdetail',compact('data'));
    ...
    public function viewUpdate(Request $request)
    {
        try{
            ...
            return redirect()->route('dashboard.form/view/detail');
        }catch(\Exception $e){
