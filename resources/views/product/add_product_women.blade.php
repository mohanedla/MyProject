                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Add a female product') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Add a female product') }}
                            <button style="float: right;" type="button"
                            data-bs-toggle="modal" data-bs-target="#type" data-bs-whatever="@mdo" class="btn btn-secondary rounded-pill">{{ __('add Type') }}</button>
                            <button style="float: right;" type="button"
                            data-bs-toggle="modal" data-bs-target="#size" data-bs-whatever="@mdo" class="btn btn-secondary rounded-pill">{{ __('Add Size') }}</button>
                            <button style="float: right;" type="button"
                            data-bs-toggle="modal" data-bs-target="#color" data-bs-whatever="@mdo" class="btn btn-secondary rounded-pill"">{{ __('Add Color') }}</button>
