...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Add a men,s product') }}
                            <button style="float: right;" type="button" data-bs-toggle="modal" data-bs-target="#type_women"
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="signup-form" action="{{ route('AddProduct') }}" method="post"
                                ...
                                @csrf
                                <div class="row">
                                    <input type="hidden" name="product_collection" value="Women">
    ...
    {{-- for categories --}}
    <div class="modal fade" id="type_women" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="{{ route('AddCategoryWomen') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="recipient-name" name="category_women_name"
