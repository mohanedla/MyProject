...
@endif
    ...
    <div class="wrapper">
                                                ...
                                                <ul class="dropdown-menu mega-dropdown-menu row">
                                                    <li class="col-md-3">
                                                        <ul>
                                                            ...
                                                            @foreach ($categoriez as $categor)
                                                                <li><a href="#">{{ __($categor->name) }}</a></li>
                                                            @endforeach
                                                        </ul>
                                                    </li>
                                                    <li class="col-md-3">
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-sm-12">
                    <div class="breadcrumb ptb_20">
                        ...
                        <ul>
                            <li><a href="home">{{ __('Home') }}</a></li>
                            <li class="active">{{ __('Product Management') }}</li>
            ...
            <div id="formContent">
                <div class="btn_add">
                                    <label class="address">{{ __('Products List') }} </label>
                                    <a href="add_product"><button id="button" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        {{ __('Add Product') }}
                                      </button></a>
