                                        ...
                                        <li class="dropdown"> <a href="#" class="dropdown-toggle"
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                @empty($old_order->count())
                                                    <li style="text-align: center;"> {{ __('There are no orders') }}
                                                    </li>
                                                @endempty
                                                {{-- @endforeach --}}
                                                {{-- @if ($old_order == []) --}}
                                            ...
                                            <div class="Sort-by col-md-6">
                                                ...
                                                <select name="product_size" id="select-by-size"
                                                    ...
                                                    @foreach ($product->sizes as $s)
                                                        <option selected
                                                            value="<?php $size = $s->size->name; ?>{{ $s->size_id }}">
                                            ...
                                            <div class="Color col-md-6">
                                                ...
                                                <select name="product_color" id="select-by-color"
                                                    ...
                                                    @foreach ($product->colors as $c)
                                                        <option selected
                                                            value="<?php $color = $c->color->name; ?>{{ $c->color_id }}">
                                    ...
                                    <div class="qty mt_30 form-group2">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST"
                                            ...
                                            <input name="quantity" min="1"
                                                max="{{ $product->quantity - $product->quantity_price }}"
                                                value="1" type="number">
                                            <input type="hidden" value="{{ $product->profile_image }}"
                                                name="image">
                                            <br>
